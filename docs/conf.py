...
project = u'vnep-approx'
copyright = u'2017, INET/TU Berlin'
author = u'INET/TU Berlin'
...
latex_documents = [
    (master_doc, 'documentation.tex', u'vnep-approx Documentation',
     u'INET/TU Berlin', 'manual'),
]
...
man_pages = [
    (master_doc, 'vnep-approx', u'vnep-approx Documentation',
     [author], 1)
]
